                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form wire:submit.prevent="updateNews" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control input-md" placeholder="Edit Expiry of this News" wire:model="expiry_date">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @else
                                            <img src="{{asset('assets/images/News')}}/{{$image}}" width="120">
                                        @endif
